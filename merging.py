...
# Code used to combine results extracted from the greedy and the optimal algorithms
...
second_csv = pd.read_csv("routes_info_optimal.csv")
...
# Merge the results from the greedy paths into the optimal algorithm CSV
...
# Update the columns in the optimal algorithm CSV
